...
function convertRoutesToDataRoutes(routes, mapRouteProperties, parentPath, manifest) {
  ...
  return routes.map((route, index) => {
    ...
    invariant$1(!manifest[id], "Found a route id collision on id \"" + id + "\".  Route " + "id's must be globally unique within Data Router usages");
    if (isIndexRoute(route)) {
      let indexRoute = _extends$3({}, route, mapRouteProperties(route), {
        id
      });
      manifest[id] = indexRoute;
      return indexRoute;
    } else {
      let pathOrLayoutRoute = _extends$3({}, route, mapRouteProperties(route), {
        id,
        children: undefined
      });
...
class DeferredData {
  constructor(data, responseInit) {
    ...
    this.deferredKeys = [];
    invariant$1(data && typeof data === "object" && !Array.isArray(data), "defer() only accepts plain objects");
...
async function loadLazyRouteModule(route, mapRouteProperties, manifest) {
  ...
  // route again.
  Object.assign(routeToUpdate, _extends$3({}, mapRouteProperties(routeToUpdate), {
    lazy: undefined
  }));
}
...
async function callLoaderOrAction(type, request, match, loadRoutePromise, handlerOverride, staticContext) {
  ...
  try {
    ...
    invariant$1(result.result !== undefined, "You defined " + (type === "action" ? "an action" : "a loader") + " for route " + ("\"" + match.route.id + "\" but didn't return anything from your `" + type + "` ") + "function. Please return a value or `null`.");
  } catch (e) {
...
export { React$1 as A, ReactDOM as B, useNavigate as C, useParams as D, ErrorResponseImpl as E, getAugmentedNamespace as F, Links as L, Meta as M, Outlet as O, React as R, Scripts as S, _extends as _, useSearchParams as a, createRouter as b, createClientRoutes as c, decodeViaTurboStream as d, getSingleFetchDataStrategy as e, createBrowserHistory as f, getPatchRoutesOnNavigationFunction as g, createClientRoutesWithHMRRevalidationOptOut as h, invariant as i, jsxRuntimeExports as j, useFogOFWarDiscovery as k, RemixContext as l, matchRoutes as m, RemixErrorBoundary as n, RouterProvider as o, mapRouteProperties as p, reactDomExports as q, reactExports as r, shouldHydrateRouteLoader as s, useRemixContext as t, useLoaderData as u, useLocation as v, useMatches as w, useScrollRestoration as x, commonjsGlobal as y, getDefaultExportFromCjs as z };
